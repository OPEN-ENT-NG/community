...
export class SearchCommunityRequestDto {
  @ApiProperty({ description: 'Unique identifier of the community', required: false })
  @IsOptional()
  id?: string;
  ...
  @ApiProperty({ description: 'Members belonging to the desired communities', required: false })
  @IsOptional()
  @Transform(({ value }) => (typeof value === 'string' ? [value] : value))
  members?: string[];
