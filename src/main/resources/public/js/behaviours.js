	    ...
	    loadResources: function (callback) {
	        return __awaiter(this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0: return [4 /*yield*/, axios_1.default.get('/community/listallpages')];
	                    case 1:
	                        response = _a.sent();
	                        communities = response.data;
	                        pagesArray = underscore_1._.map(communities, function (community) {
	                            var communityIcon;
	                        ...
	                        this.resources = underscore_1._.flatten(pagesArray);
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        return [4 /*yield*/, axios_1.default.post('/community/' + page.wiki_id + '/page', data)];
	                    case 1:
	                        _a.sent();
	                        ...
	                        return __generator(this, function (_a) {
	                            switch (_a.label) {
	                                case 0:
	                                    ...
	                                    return [4 /*yield*/, axios_1.default.get('/community/list')];
	                                case 1:
	                                    response = _a.sent();
