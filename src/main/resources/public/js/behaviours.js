...
/***/ (function(module, exports, __webpack_require__) {
	...
	entcore_1.Behaviours.register('community', {
	    rights: {
	        workflow: {
	    ...
	    loadResources: function (callback) {
	        return __awaiter(this, void 0, void 0, function () {
	            var response, communities, pagesArray;
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0: return [4 /*yield*/, entcore_toolkit_1.http.get('/community/listallpages')];
	                    case 1:
	                        response = _a.sent();
	                        communities = response.data;
	                        pagesArray = entcore_2._.map(communities, function (community) {
	                            var communityIcon;
	                            ...
	                            return {
	                                ...
	                                icon: communityIcon,
	                                path: '/community#/view/' + community.id,
	                                community_id: community.id,
	                                id: community.id
	                            };
	                        });
	                        this.resources = entcore_2._.flatten(pagesArray);
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        ...
	                        return [4 /*yield*/, entcore_toolkit_1.http.post('/community/' + page.wiki_id + '/page', data)];
	                    case 1:
	                        _a.sent();
	        ...
	        navslider: {
	            ...
	            controller: {
	                        ...
	                        return __generator(this, function (_a) {
	                            switch (_a.label) {
	                                case 0:
	                                    ...
	                                    return [4 /*yield*/, entcore_toolkit_1.http.get('/community/list')];
	                                case 1:
	                                    response = _a.sent();
	                ...
	                openCommunity: function (community) {
	                    window.location.href = '/community#/view/' + community.id;
